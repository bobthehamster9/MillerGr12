...
public class StudentInfo {
    ...
    private JTextField surnameOrSNTextField;
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        panel = new JPanel();
        panel.setLayout(new GridLayoutManager(12, 10, new Insets(0, 0, 0, 0), -1, -1));
        ...
        panel.add(gradeLabel, new GridConstraints(5, 1, 1, 1, GridConstraints.ANCHOR_EAST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ageLabel = new JLabel();
        ...
        panel.add(ageLabel, new GridConstraints(5, 5, 1, 1, GridConstraints.ANCHOR_EAST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        panel.add(ageField, new GridConstraints(5, 6, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0, false));
        ...
        list1 = new JList();
        Font list1Font = this.$$$getFont$$$("Microsoft YaHei UI", Font.BOLD, -1, list1.getFont());
        if (list1Font != null) list1.setFont(list1Font);
        list1.setForeground(new Color(-26292));
        list1.setSelectionBackground(new Color(-26292));
        panel.add(list1, new GridConstraints(1, 8, 11, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_WANT_GROW, null, new Dimension(150, 50), null, 0, false));
        surnameOrSNTextField = new JTextField();
        surnameOrSNTextField.setEnabled(true);
        surnameOrSNTextField.setFocusable(false);
        Font surnameOrSNTextFieldFont = this.$$$getFont$$$("Microsoft YaHei UI", Font.BOLD, -1, surnameOrSNTextField.getFont());
        if (surnameOrSNTextFieldFont != null) surnameOrSNTextField.setFont(surnameOrSNTextFieldFont);
        surnameOrSNTextField.setForeground(new Color(-1));
        surnameOrSNTextField.setText("Surname or SN");
        panel.add(surnameOrSNTextField, new GridConstraints(0, 8, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0, false));
        ...
        panel.add(SEARCHButton, new GridConstraints(0, 9, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        panel.add(ALPHABETICALLYRadioButton, new GridConstraints(1, 9, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        panel.add(AGERadioButton, new GridConstraints(3, 9, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        panel.add(courseListBox, new GridConstraints(7, 9, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        panel.add(ADDButton, new GridConstraints(10, 9, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        course7Field.setForeground(new Color(-3121058));
        ...
        course8Field.setForeground(new Color(-3121058));
        ...
        defaultComboBoxModel2.addElement("Grade");
        gradeListBox.setModel(defaultComboBoxModel2);
        panel.add(gradeListBox, new GridConstraints(6, 9, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        panel.add(SELECTButton, new GridConstraints(11, 9, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        panel.add(GRADESRadioButton, new GridConstraints(2, 9, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        yearBox.setForeground(new Color(-3121058));
        ...
        dayBox.setForeground(new Color(-3121058));
        ...
        monthBox.setForeground(new Color(-3121058));
        ...
        comboBox14.setBackground(new Color(-3121058));
        comboBox14.setEnabled(true);
        comboBox14.setForeground(new Color(-3121058));
        panel.add(comboBox14, new GridConstraints(5, 2, 1, 3, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        provBox = new JComboBox();
        provBox.setBackground(new Color(-3121058));
        provBox.setForeground(new Color(-3121058));
        ...
        genderBox.setForeground(new Color(-3121058));
